...
After jumping from plugin to plugin for various use-cases, and having to keep update my Markdown and CSS source files as a result, I decided to build Mercenary so I can standardize on my own conventions for extending Markdown syntax with React components.
